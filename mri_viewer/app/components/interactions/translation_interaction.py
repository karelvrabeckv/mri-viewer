        ...
        with vuetify3.VCardText():
            with vuetify3.VRow(justify="center", classes="my-4"):
                button(
                    ...
                    click=(self.ctrl.translate, f"['{const.Directions.XAxisMinus}']"),
                )
                ...
                button(
                    ...
                    click=(self.ctrl.translate, f"['{const.Directions.XAxisPlus}']"),
                )
            ...
            with vuetify3.VRow(justify="center", classes="my-4"):
                button(
                    ...
                    click=(self.ctrl.translate, f"['{const.Directions.YAxisMinus}']"),
                )
                ...
                button(
                    ...
                    click=(self.ctrl.translate, f"['{const.Directions.YAxisPlus}']"),
                )
            ...
            with vuetify3.VRow(justify="center", classes="my-4"):
                button(
                    ...
                    click=(self.ctrl.translate, f"['{const.Directions.ZAxisMinus}']"),
                )
                ...
                button(
                    ...
                    click=(self.ctrl.translate, f"['{const.Directions.ZAxisPlus}']"),
                )
