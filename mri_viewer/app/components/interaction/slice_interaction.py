...
def slice_interaction():
    with vuetify3.VCard(v_show=f"current_representation == {Representation.Slice}", classes="ma-4"): 
        # Title
        vuetify3.VCardTitle("{{ language.section_slice_title }}", classes="text-white bg-grey-darken-1 py-1")
